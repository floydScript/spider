...
class Toplist_dd(RedisSpider):
    name = 'toplist_dd'

    allowed_domains = ['dangdang.com']

    redis_key = 'toplist_dd:start_urls'
    ...
    def comment_inter(self,productId):
        try:
            url = 'http://product.dangdang.com/index.php?r=comment%2Flist&productId=' + productId + '&categoryPath=01.41.26.15.00.00&mainProductId=' + productId + '&mediumId=0&pageIndex=1&sortType=1&filterType=1&isSystem=1&tagId=0&tagFilterCount=0&template=publish'
            response = requests.get(url)
